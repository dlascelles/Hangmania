...
{
    /// <summary>
    /// Controls the visibility of the progress bar while playing the game in 'Time mode'.
    /// </summary>
    public class GameStartedTimedProgressVisibilityConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            if (System.Convert.ToBoolean(values[0]) == true && values[1] is GameTimed)
            {
